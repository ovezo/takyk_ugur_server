...
use Domain\UserNotification\Requests\UserNotificationRequest;
...
class UserNotificationCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\Domain\UserNotification\Models\UserNotification::class);
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('time_from');
        CRUD::column('time_to');
        CRUD::column('active_status');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('stop_id');
        CRUD::field('route_id');
        CRUD::field('time_from');
        CRUD::field('time_to');
        CRUD::field('active_status');
